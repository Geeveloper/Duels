...
public class IronKit extends KitManager {

	@Override
	public ItemStack getHelmet() {
		ItemStack helmet = new ItemStack(Material.IRON_HELMET);
		ItemMeta helm = helmet.getItemMeta();
		helm.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&f&l&oIron Kit"));
	...
	public List<ItemStack> getMisc() {
		...
		//apples
		misc.add(new ItemStack(Material.GOLDEN_APPLE, 4));

		//food
		ItemStack food = new ItemStack(Material.COOKED_BEEF, 14);
		misc.add(food);
